const e=[{date:1731370468e3,author:"HAZEL",title:"Empty Baskets",content:`Harvest comes to a close and Classic mode returns to the island, but more is soon to come. We will be holding a <strong>closed beta test for accounts</strong> in the not-so-distant future, so stay tuned to official Suroi channels for information on how to participate.

<br><a href="#">The rules</a> have been updated. Please take the time to read them.`},{date:1730689557e3,author:"HAZEL",title:"Autumn Wilt",content:"The spooky season comes to a close, and the Plumpkins have died off. We hoped you enjoyed this year's Halloween mode, and will be taking your feedback into account for future events. Harvest will continue until <strong>November 11th</strong>, but will return in future as a rotating mode."},{date:1730428409e3,author:"HAZEL",title:"Plumpkin Panic",bannerImage:"../img/news/v0.21.0.png",content:`<strong>Happy Halloween!</strong> It's that time of year again, and the Plumpkins have broken out of the bunker, leaving the island covered in brand new perk opportunities. The Harvest map has been changed to fit the festivities, with a delightfully spooky theme.
...
<br><br>Halloween will run for <strong>3 days</strong>, until 8 PM EST, Nov 3rd.`,longContent:`<h2>Suroi v0.21.0</h2>
<h3>New features</h3>
<ul>
...
<li>Fixed team pings rendering below airdrop parachutes.</li>
  </ul>`},{date:1730057509e3,author:"HAZEL",title:"Open Season",bannerImage:"../img/news/v0.20.0.png",content:`Fall settles on a brand new mode, <strong>Harvest</strong>, bringing a plethora of <strong>new guns</strong>, a wide assortment of <strong>Perks</strong>, and the mysterious <strong>Plumpkins...</strong>
...
</ul>`},{date:1727030995e3,author:"HAZEL",title:"High-Caliber Negotiations",bannerImage:"../img/news/v0.19.0.png",content:`
